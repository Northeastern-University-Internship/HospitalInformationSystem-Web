        ...
        <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
          <el-menu default-active="1" unique-opened=true>
            ...
            <el-submenu index="1">
              ...
              <el-menu-item index="register" @click="goTo('/index/registration')">On-site registration</el-menu-item>
              <el-menu-item index="withdraw" @click="goTo('/index/withdraw')">Cancel Registration</el-menu-item>
              <el-menu-item index="refund" @click="goTo('/index/refund')">Refund</el-menu-item>
              <el-menu-item index="charges" @click="goTo('/index/charges')">Withdraw Charges</el-menu-item>
              <el-menu-item index="expense" @click="goTo('/index/expense')">Expense Record Query</el-menu-item>
            </el-submenu>
            <el-submenu index="2">
              ...
              <el-menu-item index="mrecords" @click="goTo('/index/mrecords')">Medical records</el-menu-item>
