        ...
        <div class="header-avatar">
          ...
          <el-dropdown style="margin-left: 10px">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="selectMenu({name: 'UserCenter', title: 'Edit'})">
                <router-link to="/userCenter" >Edit</router-link></el-dropdown-item>
...
<script>
import SideMenu from "@/views/navigationFunction/SideMenu";
import Tabs from "@/views/navigationFunction/Tabs";
export default {
  name: "Home",
  components: {
    SideMenu,
