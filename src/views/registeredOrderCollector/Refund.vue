        ...
        <el-table
          ...
          <el-table-column label="operate" width="200px">
            <template slot-scope="scope">
              <el-button type ="warning" @click="doGet(scope.row)" plain>Edit</el-button>
              <el-button type ="danger" @click="doBack(scope.row)" plain>Delete</el-button>
            </template>
          </el-table-column>
      ...
      <el-dialog
        ...
        <el-form
          ...
          <el-form-item label="Invoice number:" prop="invoiceNum">
            <el-input class="box-card" v-model="invoiceInFormation.invoiceNum" placeholder="Invoice Number"></el-input>
          </el-form-item>
          <el-form-item label="Invoice amount:" prop="money">
            <el-input class="box-card" v-model="invoiceInFormation.money" placeholder="Invoice amount"></el-input>
          </el-form-item>
          <el-form-item label="Invoice status:" prop="state">
            <el-input class="box-card" v-model="invoiceInFormation.state" placeholder="Invoice Status"></el-input>
          </el-form-item>
          ...
          <el-form-item label="Red invoice number:" prop="back">
            <el-input class="box-card" v-model="invoiceInFormation.back" placeholder="Red Invoice Number"></el-input>
          </el-form-item>
          <el-form-item label="Invoice status:" prop="dailyState">
            <el-input class="box-card" v-model="invoiceInFormation.dailyState" placeholder="Invoice Status"></el-input>
          </el-form-item>
        </el-form>
<!-- <template slot-scope="scope">-->
